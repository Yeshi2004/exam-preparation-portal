...
<div>
<a class="view-btn" href="uploads/notes/<?php echo htmlspecialchars($row['file']); ?>" target="_blank">
View
</a>

<a class="download-btn" href="uploads/notes/<?php echo htmlspecialchars($row['file']); ?>" download>
Download
</a>
